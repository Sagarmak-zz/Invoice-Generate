          ...
          <div class="column is-5">
            <div class="date" v-if="select == 'date'">
              <div class="field">
                ...
                <p class="control">
                  <datepicker v-model="start_date" v-validate="'required'" placeholder="Select End Date" :config="{ dateFormat: 'Y-m-d' }" name="start_date" :class="{'input': true, 'is-danger': errors.has('start_date') }">
                  </datepicker>
                </p>
              </div>
              <div class="field">
                ...
                <p class="control">
                  <datepicker v-model="end_date" v-validate="'required'" placeholder="Select End Date" :config="{ dateFormat: 'Y-m-d' }" name="end_date" :class="{'input': true, 'is-danger': errors.has('end_date') }">
                  </datepicker>
                </p>
              </div>
            ...
            <div class="invoice_number" v-if="select == 'invoice_number'">
              <div class="form">
                ...
                <p class="control">
                  <input v-model="invNum" :class="{'input': true, 'is-danger': errors.has('inv_num') }" name="inv_num" v-validate="'required'" type="text" placeholder="Invoice Number">
                </p>
              </div>
              <div class="field" v-if="select != ''">
                <button @click="generateInvoiceReport" class="button is-primary generate-report"> Generate Report </button>
              </div>
            </div>
            <div class="firm_name" v-if="select == 'firm_name'">
              <div class="form">
                ...
                <p class="control">
                  <input v-model="firm_name" :class="{'input': true, 'is-danger': errors.has('firm_name') }" name="firm_name" v-validate="'required'" type="text" placeholder="Firm Name">
                </p>
              </div>
              <div class="field" v-if="select != ''">
                <button @click="generateFirmNameReport" class="button is-primary generate-report"> Generate Report </button>
              </div>
            </div>
            <div class="customer_name" v-if="select == 'customer_name'">
              <div class="form">
                ...
                <p class="control">
                  <input v-model="customer_name" :class="{'input': true, 'is-danger': errors.has('cus_name') }" name="cus_name" v-validate="'required'" type="text" placeholder="Customer Name">
                </p>
              </div>
              <div class="field" v-if="select != ''">
                <button @click="generateCusNameReport" class="button is-primary generate-report"> Generate Report </button>
              </div>
            </div>
          </div>
        </div>
